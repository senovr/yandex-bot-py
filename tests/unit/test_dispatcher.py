...
from ymbot_async.dispatcher.handlers import MessageHandler, Handler
...
class TestDispatcherProcessUpdate:
    ...
    @pytest.mark.asyncio
    async def test_process_update_no_matching_handler(self, bot_config, mock_api_client, sample_update):
    ...
    @pytest.mark.asyncio
    async def test_process_update_first_handler_wins(self, bot_config, mock_api_client, sample_update):
    ...
    @pytest.mark.asyncio
    async def test_process_update_handler_exception(self, bot_config, mock_api_client, sample_update):
...
class TestDispatcherConcurrency:
    ...
    @pytest.mark.asyncio
    async def test_semaphore_limits_concurrent_tasks(self, bot_config, mock_api_client, sample_update):
...
class TestDispatcherIntegration:
    ...
    @pytest.mark.asyncio
    async def test_multiple_handlers_different_filters(self, bot_config, mock_api_client, sample_update):
